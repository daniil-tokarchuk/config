...
alias cdf="cd ${HOME}/Projects/dom/dom-frontend"
alias cdb="cd ${HOME}/Projects/dom/backend"
...
alias du="docker compose -f compose.yaml up --build -d"
...
if [ -e "$PAM_CONFIG" ] && ! grep -q "$PAM_TID" "$PAM_CONFIG"; then
